...
array_of_equations(end + 1) = sin(2*pi*estimated_freq(k) * t_input(k) * z_power);

array_of_equations(end + 1) = cos(2*pi*estimated_freq(k) * t_input(k) * z_power);

end

if second_harmonic_filter

array_of_equations(end + 1) = sin(2 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

array_of_equations(end + 1) = cos(2 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

end

if third_harmonic_filter

array_of_equations(end + 1) = sin(3 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

array_of_equations(end + 1) = cos(3 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

end

if fourth_harmonic_filter

array_of_equations(end + 1) = sin(4 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

array_of_equations(end + 1) = cos(4 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

end

if fifth_harmonic_filter

array_of_equations(end + 1) = sin(5 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

array_of_equations(end + 1) = cos(5 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

end

if sixth_harmonic_filter

array_of_equations(end + 1) = sin(6 * 2*pi*estimated_freq(k) * t_input(k) * z_power);

array_of_equations(end + 1) = cos(6 * 2*pi*estimated_freq(k) * t_input(k) * z_power);
...
target_pinv_A = nested_matrix_pinv_A{n}; % Use curly braces to get the matrix out
