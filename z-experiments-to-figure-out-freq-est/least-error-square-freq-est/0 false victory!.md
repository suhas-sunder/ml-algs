...
x = Vm_input * sin(omega_input * t_input + pi/18) + Vm_input * sin(2*omega_input * t_input + pi/18) + Vm_input * sin(3*omega_input * t_input + pi/18) + Vm_input * sin(4*omega_input * t_input + pi/18) + Vm_input * sin(5*omega_input * t_input + pi/18) + Vm_input * sin(6*omega_input * t_input + pi/18); % Input waveform
...
delta = unwrapped_phase(n) - unwrapped_phase(n-1);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

new_freq_estimate = abs(delta) / ((2 * pi) / fs);

disp(new_freq_estimate)
...
if(abs(new_freq_estimate - estimated_freq(n-1)) <= tolerance )
